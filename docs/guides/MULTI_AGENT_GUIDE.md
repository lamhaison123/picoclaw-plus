...
> **NEW!** Check out [Collaborative Chat](COLLABORATIVE_CHAT.md) for IRC-style multi-agent conversations in Telegram!
...
For interactive multi-agent conversations in Telegram, see:
- [Collaborative Chat Quick Start](COLLABORATIVE_CHAT_QUICKSTART.md) - Get started in 5 minutes
- [Collaborative Chat Guide](COLLABORATIVE_CHAT.md) - Full documentation

Collaborative chat enables IRC-style conversations where you can @mention multiple agents and they'll all respond with full context:

```
User: @architect @developer How should we implement this?

[abc123] 🏗️ ARCHITECT: I recommend...
